...
var meunbarsymbol = document.getElementById("menubar-symbol")
var xbar1 = document.getElementById("xbar1")
var sidemenu = document.getElementById("sidemenu-links")

meunbarsymbol.addEventListener("click",function(){
   sidemenu.style.marginLeft ="0px"
})
 
xbar1.addEventListener("click",function(){
    sidemenu.style.marginLeft="-60%"
})



// var sec4buttn =document.querySelector("sec-4buttn")
// var overlay =document.querySelector("overlay")
// var sec4cont = document.querySelector("sec_4cont")


// sec4cont.addEventListener("click",function(){
//     sec4buttn.style.display="block"
// })